-- ============================================================
-- 22: BATCH NUMBER — BUSINESS FORMAT ONLY (no UUID/random fragment)
-- Format: BATCH-{GRN_NUMBER}-{YYYYMMDD}-{SEQ}  e.g. BATCH-GRN-000061-20260207-001
-- Expiry date kept. UUID-derived middle part removed.
-- ============================================================
