...
-- pr_po_linkage indexes (critical for PR ↔ PO traversal)
...
-- grn_inspections indexes (critical for PO ↔ GRN traversal)
...
-- purchasing_invoices indexes (critical for GRN ↔ PUR and PO ↔ PUR traversal)
...
CREATE INDEX IF NOT EXISTS idx_purchase_request_items_deleted ON purchase_request_items(deleted);
